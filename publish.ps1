...
dotnet publish src/Sms/FeeSyncer.Sms.csproj -c $configuration -r $runtime $scFlag -o $servicePublish

Write-Host "Publishing FeeSyncer.Agent..." -ForegroundColor Cyan
dotnet publish src/Agent/FeeSyncer.Agent.csproj -c $configuration -r $runtime $scFlag -o $agentPublish

Write-Host "Publishing FeeSyncer.Tray..." -ForegroundColor Cyan
dotnet publish src/Tray/FeeSyncer.Tray.csproj -c $configuration -r $runtime $scFlag -o $trayPublish

Write-Host "Publishing FeeSyncer.Console..." -ForegroundColor Cyan
dotnet publish src/Console/FeeSyncer.Console.csproj -c $configuration -r $runtime $scFlag -o $consolePublish
