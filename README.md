...
- Successful Tests runs on `main` can publish four ZIPs and two installers to the private GitHub release, while the two installer executables are also published to the public S3 update channel.
