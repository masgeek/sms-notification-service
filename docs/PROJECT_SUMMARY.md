...
There are 73 xUnit tests in thirteen source files:

| Project | Facts | Main coverage |
|---|---:|---|
| SMS | 18 | Sender results/backoff, processor flows, tray compatibility source checks |
| Agent | 36 | Hosting and standardized logging, contracts/hashing, lease fencing, redacted debug samples, school API mapping, HTTP diagnostics, MQTT control/events, wake signal |
